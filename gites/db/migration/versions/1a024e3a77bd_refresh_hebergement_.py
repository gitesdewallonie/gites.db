"""Refresh hebergement_view for heb_url

Revision ID: 1a024e3a77bd
Revises: 42663b5d9f45
Create Date: 2014-02-17 15:52:28.299271

"""

# revision identifiers, used by Alembic.
revision = '1a024e3a77bd'
down_revision = '42663b5d9f45'

from alembic import op


def upgrade():
    print "... Refresh hebergement_view for heb_url"
...
def downgrade():
    print "... No, you don't want to un-refresh :-)"
