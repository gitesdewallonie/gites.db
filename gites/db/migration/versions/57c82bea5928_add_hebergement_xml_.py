"""Add hebergement_xml_view

Revision ID: 57c82bea5928
Revises: 1e9102c64265
Create Date: 2015-12-04 09:22:52.564312

"""

# revision identifiers, used by Alembic.
revision = '57c82bea5928'
down_revision = '1e9102c64265'

from alembic import op


def upgrade():
    print '... Create the hebergement xml view'
    op.execute("""
        CREATE VIEW hebergement_xml_view AS
        SELECT hebergement.heb_pk,
               ...
               CASE heb_carte_cke.link_met_value WHEN true THEN 'oui' ELSE 'non' END as heb_carte_cke,
               CASE heb_commercialisation.link_met_value WHEN true THEN 'oui' ELSE 'non' END as heb_commercialisation,
               CASE
        ...
        LEFT JOIN link_hebergement_metadata AS heb_carte_cke
               ON heb_carte_cke.heb_fk = hebergement.heb_pk AND heb_carte_cke.metadata_fk = 99
        LEFT JOIN link_hebergement_metadata AS heb_commercialisation
               ON heb_commercialisation.heb_fk = hebergement.heb_pk AND heb_commercialisation.metadata_fk = 100
        LEFT JOIN commune
...
def downgrade():
    print '... Drop the hebergement xml view'
    op.execute('DROP VIEW hebergement_xml_view')
