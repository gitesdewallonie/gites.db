"""update hebergement view

Revision ID: d25490bba2c
Revises: 3d69b33f687a
Create Date: 2014-10-13 09:46:07.559025

"""

# revision identifiers, used by Alembic.
revision = 'd25490bba2c'
down_revision = '59a12a2f90c0'
...
def upgrade():
    print '... Update the hebergement view'
    ...
    op.execute("""
        ...
        SELECT hebergement.heb_pk,
               ...
               provinces.prov_code
        FROM hebergement
        LEFT OUTER JOIN tarifs AS heb_tarif_we_bs
        ...
        LEFT OUTER JOIN tarifs as heb_tarif_sem_bs
        ...
        LEFT OUTER JOIN tarifs AS heb_tarif_we_ms
        ...
        LEFT OUTER JOIN tarifs AS heb_tarif_sem_ms
        ...
        LEFT OUTER JOIN tarifs AS heb_tarif_we_hs
        ...
        LEFT OUTER JOIN tarifs AS heb_tarif_sem_hs
        ...
        LEFT OUTER JOIN tarifs AS heb_tarif_we_3n
        ...
        LEFT OUTER JOIN tarifs AS heb_tarif_we_4n
        ...
        LEFT OUTER JOIN tarifs AS heb_tarif_semaine_fin_annee
        ...
        LEFT OUTER JOIN tarifs AS heb_tarif_garantie
        ...
        LEFT OUTER JOIN tarifs AS heb_taxe_montant
        ...
        LEFT OUTER JOIN tarifs AS heb_tarif_divers
        ...
        LEFT OUTER JOIN tarifs AS heb_tarif_chmbr_avec_dej_1p
        ...
        LEFT OUTER JOIN tarifs AS heb_tarif_chmbr_avec_dej_2p
        ...
        LEFT OUTER JOIN tarifs AS heb_tarif_chmbr_pers_sup
        ...
        LEFT OUTER JOIN tarifs AS heb_tarif_chmbr_sans_dej
        ...
        LEFT OUTER JOIN tarifs AS heb_tarif_chmbr_table_hote_1p
        ...
        LEFT OUTER JOIN tarifs AS heb_tarif_charge
